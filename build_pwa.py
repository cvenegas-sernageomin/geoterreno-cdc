...
<style>
  :root{--verde:#1f6f4f;--verde2:#2a8f66;--azul:#2166a8;--naranja:#c47a1a;--gris:#f4f5f7;--bd:#d6d9de;--txt:#20242b;--rojo:#c0392b}
  *{box-sizing:border-box}
  body{margin:0;font-family:system-ui,-apple-system,Segoe UI,Roboto,sans-serif;color:var(--txt);background:var(--gris);-webkit-text-size-adjust:100%}
  header{background:var(--verde);color:#fff;padding:10px 14px;display:flex;align-items:center;gap:10px;position:sticky;top:0;z-index:10;box-shadow:0 2px 6px rgba(0,0,0,.15)}
  header h1{font-size:16px;margin:0;flex:1;font-weight:600}
  header .ctx{font-size:11px;opacity:.9;font-weight:400}
  main{max-width:820px;margin:0 auto;padding:12px 12px 90px}
  .card{background:#fff;border:1px solid var(--bd);border-radius:10px;padding:12px;margin-bottom:12px;box-shadow:0 1px 2px rgba(0,0,0,.04)}
  .card h2{font-size:14px;margin:0 0 10px;color:var(--verde);display:flex;align-items:center;gap:8px}
  .row{display:flex;flex-wrap:wrap;gap:10px}
  .fld{display:flex;flex-direction:column;gap:3px;margin-bottom:9px;flex:1 1 220px;min-width:0}
  .fld label{font-size:11.5px;font-weight:600;color:#444}
  .fld label .req{color:var(--rojo);margin-left:2px}
  .fld input,.fld select,.fld textarea{padding:8px;border:1px solid var(--bd);border-radius:7px;font-size:14px;font-family:inherit;background:#fff;width:100%}
  .fld textarea{resize:vertical;min-height:56px}
  .fld .nota{font-size:10px;color:#888}
  .fld input:invalid{border-color:var(--rojo)}
  button{font-family:inherit;font-size:14px;border:none;border-radius:8px;padding:9px 14px;cursor:pointer;font-weight:600}
  .btn{background:var(--verde);color:#fff}
  .btn.sec{background:#e9edf1;color:#333}
  .btn.mini{padding:6px 10px;font-size:12px}
  .btn.del{background:#f6e2df;color:var(--rojo)}
  ...
  .list-item{display:flex;align-items:center;gap:10px;padding:10px;border:1px solid var(--bd);border-radius:8px;margin-bottom:8px;background:#fff;cursor:pointer}
  .list-item:hover{background:#fafbfc}
  .list-item .t{flex:1;min-width:0}
  .list-item .t b{font-size:14px}
  .list-item .t small{color:#666;font-size:11.5px;display:block}
  .pill{font-size:10px;padding:2px 7px;border-radius:20px;background:#eef2f5;color:#555}
  .empty{color:#999;font-size:13px;text-align:center;padding:18px}
  .child-block{border-left:3px solid var(--naranja);padding:8px 10px;margin:8px 0;background:#fcfaf6;border-radius:0 8px 8px 0}
  .child-block.lito{border-color:var(--verde2);background:#f5fbf8}
  .child-block .hd{display:flex;align-items:center;gap:8px;font-weight:600;font-size:13px;margin-bottom:6px}
  .child-block .hd .n{flex:1}
  fieldset{border:1px solid var(--bd);border-radius:8px;margin:0 0 10px;padding:8px 10px}
  legend{font-size:12px;font-weight:700;color:var(--naranja);padding:0 6px}
  legend.lito{color:var(--verde2)}
  .fab{position:fixed;left:0;right:0;bottom:0;background:#fff;border-top:1px solid var(--bd);padding:8px 12px;display:flex;gap:8px;max-width:820px;margin:0 auto;z-index:9}
  .toast{position:fixed;bottom:70px;left:50%;transform:translateX(-50%);background:#222;color:#fff;padding:10px 16px;border-radius:22px;font-size:13px;opacity:0;transition:.3s;z-index:99;pointer-events:none}
  .toast.on{opacity:.95}
  .thumbs{display:flex;gap:6px;flex-wrap:wrap}
  .thumbs img{width:64px;height:64px;object-fit:cover;border-radius:6px;border:1px solid var(--bd)}
  canvas.sketch{border:1px solid var(--bd);border-radius:8px;touch-action:none;background:#fff;width:100%;max-width:100%}
  .muted{color:#888;font-size:12px}
  .warn{background:#fff6e6;border:1px solid #f0d38a;border-radius:8px;padding:8px 10px;font-size:12px;color:#7a5a12;margin-bottom:10px}
  a.link{color:var(--azul);cursor:pointer;text-decoration:underline;font-size:12px}
  select:disabled{background:#f0f0f0;color:#999}
  .mapbox{height:320px;width:100%;border:1px solid var(--bd);border-radius:8px;z-index:0}
